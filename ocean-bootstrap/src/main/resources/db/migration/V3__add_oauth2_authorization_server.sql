-- Spring Authorization Server 1.2.3 JDBC schema, adapted for PostgreSQL.
-- The official JDBC implementations use unqualified table names; application
-- configuration sets ocean_platform as the default schema for their JdbcTemplate.
